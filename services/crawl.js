...
const obj = {
    ...
    async getBookData() {
        ...
        let name = '格列佛游记';
        let contentDbName = 'geliefoyouji';
        ...
        let originListEle = " a";
        let originDetailEle = "tr";
        let currentContentEle = 4;
        let currentCrawlEle = 3;
        let url = 'http://www.eywedu.net/glfyj/index.html';
        let crawlEncoding = 'gbk';
        let crawlHost = "http://www.eywedu.net/glfyj/";
        // 自定义结束
        ...
        for ( let i = 0, r = elements.length; i < r; i++ ) {
            ...
            let content = $(originDetailEle).slice(currentContentEle).html();
            // console.log(content);
            // console.log(originDetailEle)
            content = content.replace(/<div style="FLOAT: left">.+<\/div>/g,'');
            content = content.replace('http://www.eywedu.com/xispanodspanohspanng.js','')
